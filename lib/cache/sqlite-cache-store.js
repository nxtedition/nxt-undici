 ...
 *  vary?: string | object
 *  body: string
 * } & import('undici-types/cache-interceptor.d.ts').default.CacheValue} SqliteStoreValue
 */
export class SqliteCacheStore {
  ...
  /**
   * @param {import('undici-types/cache-interceptor.d.ts').default.CacheKey} key
   * @param {import('undici-types/cache-interceptor.d.ts').default.CacheValue & { body: Buffer | null }} value
   */
  set(key, value) {
