  ...
  for (let i = 0; i < directives.length; i++) {
    ...
    switch (key) {
      ...
      case 'no-store':
        ...
        // fails restrictive as the bare directive: dropping it would allow
        // storage/reuse that the sender attempted to prohibit.
        output[key] = true
        break
      ...
      case 'proxy-revalidate': {
        ...
        // (RFC 9111 §3.5). A valid duplicate dominates an invalid one.
        if (value === undefined) {
          output[key] = true
